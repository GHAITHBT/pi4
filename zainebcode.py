...
# Flask endpoint to receive matched materials and activate the corresponding LEDs
...
# Button callback to handle confirmation and turn off the corresponding LED
def button_callback(channel):
    # Find the material corresponding to the button pin
    material = None
    ...
    if material:
        # Turn off the LED for the material
